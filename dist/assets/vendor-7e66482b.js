...
function initIntersectionObserver(_c) {
  var _d = _c, { root } = _d, options = __objRest(_d, ["root"]);
...
function spring(_e) {
  var _f = _e, { keyframes: keyframes2, restDelta, restSpeed } = _f, options = __objRest(_f, ["keyframes", "restDelta", "restSpeed"]);
...
function animateValue(_g) {
  var _h = _g, { autoplay = true, delay: delay2 = 0, driver = frameloopDriver, keyframes: keyframes$1, type = "keyframes", repeat = 0, repeatDelay = 0, repeatType = "loop", onPlay, onStop, onComplete, onUpdate } = _h, options = __objRest(_h, ["autoplay", "delay", "driver", "keyframes", "type", "repeat", "repeatDelay", "repeatType", "onPlay", "onStop", "onComplete", "onUpdate"]);
  let speed = 1;
...
function createAcceleratedAnimation(value, valueName, _i) {
  var _j = _i, { onUpdate, onComplete } = _j, options = __objRest(_j, ["onUpdate", "onComplete"]);
...
function isTransitionDefined(_k) {
  var _l = _k, { when, delay: _delay, delayChildren, staggerChildren, staggerDirection, repeat, repeatType, repeatDelay, from, elapsed } = _l, transition = __objRest(_l, ["when", "delay", "delayChildren", "staggerChildren", "staggerDirection", "repeat", "repeatType", "repeatDelay", "from", "elapsed"]);
...
function MeasureLayout(props) {
  ...
  return React.createElement(MeasureLayoutWithContext, __spreadProps(__spreadValues({}, props), { layoutGroup, switchLayoutGroup: reactExports.useContext(SwitchLayoutGroupContext), isPresent, safeToRemove }));
}
...
function resolveCSSVariables(visualElement, _m, transitionEnd) {
  var target = __objRest(_m, []);
...
class VisualElement {
  ...
  loadFeatures(_n, isStrict, preloadedFeatures2, initialLayoutGroupConfig) {
    var _o = _n, { children } = _o, renderedProps = __objRest(_o, ["children"]);
...
class DOMVisualElement extends VisualElement {
  ...
  makeTargetAnimatableFromInstance(_p, { transformValues }, isMounted) {
    var _q = _p, { transition, transitionEnd } = _q, target = __objRest(_q, ["transition", "transitionEnd"]);
...
function scrollInfo(onScroll, _r = {}) {
  var _s = _r, { container = document.documentElement } = _s, options = __objRest(_s, ["container"]);
...
function useScroll(_t = {}) {
  var _u = _t, { container, target, layoutEffect = true } = _u, options = __objRest(_u, ["container", "target", "layoutEffect"]);
